...
(function() {
      ...
      for (var e = 0; e < d.length; e++) {
        ...
        null !== b &&
          (!0 === b.ye.call(b.Yg)
            ? (d[e] = null)
            : D.Sc(b.repeat) &&
              ((b.repeat = b.repeat - 1), 0 >= b.repeat && (d[e] = null)));
      }
      d = d.filter(function(a) {
        return null !== a;
      });
    ...
    Object.defineProperty(a.prototype, "font", {
      set: function(a) {
        ...
        if (1 < c.length) {
          ...
          this.O.font = this.Nc[d].replace(
            "#SIZE#",
            (this.hc[d] * this.ga[0]).toString()
          );
        }
      }
    });
  ...
  var S = new (function() {
    ...
    this.Cg = function(a) {
      ...
      return (
        Math.sqrt(
          65025 * d * d * 0.241 + 65025 * a * a * 0.691 + 65025 * c * c * 0.068
        ) / 255
      );
    };
    this.Ng = function(a) {
  ...
  var D = {
    ...
    B: function() {
      for (var a = 0; a < arguments.length; a++) {
        var l = arguments[a];
        if (!(D.V(l) || (D.Sc(l) && isNaN(l)) || (D.Tc(l) && D.jf(l))))
          return l;
      }
    },
    cg: function(a, l) {
  ...
  function wa() {
    ...
    this.p = function(l, k) {
      ...
      if (f)
        for (
          var d = Array.prototype.slice.call(arguments, 1), c = 0;
          c < f.length;
          c++
        )
          f[c].apply(this, d);
    ...
    function l(b, d, k) {
      ...
      this.xf = function(a) {
        ...
        if (0 !== d.length) {
          var b;
          D.V(p)
            ? ((p = 0), (b = d[p]), b.W && b.W.call(b, a, r, l))
            : (b = d[p]);
          for (; p < d.length; ) {
  ...
  var M = new (function() {
    ...
    this.k = function(a, f) {
      for (
        var d = 0, c = 0, g = a.length, m = a[0], e = 0, b = 1;
        b < g - 1;
        b++
      )
        var h = a[b],
    ...
    this.Va = function(a, f) {
      for (var d = 0; d < a.length; d++) {
        var c = a[d],
          g = a[d + 1] || a[0];
        if (0 > (f.y - c.y) * (g.x - c.x) - (f.x - c.x) * (g.y - c.y))
          return !1;
      }
      return !0;
    };
    ...
    this.qe = function(a, f, d) {
      ...
      return M.Aa(
        d,
        l(a, c, { x: c.x + Math.cos(f), y: c.y + Math.sin(f) }),
        c,
        {}
      );
    };
      ...
      if (
          ...
          for (e = 4; e < n; e++)
            for (f = c[e], g = 0; 4 > g; g++)
              (h = q[g]),
                (k = h.ma[0]),
                (m = h.Oa),
                0 > m.x * (f.x - k.x) + m.y * (f.y - k.y) + m.z * (f.z - k.z) &&
                  a.d(h, f);
          return 4;
        })())
      ) {
        for (; p < n; ) {
          ...
          if (b.$b) {
            ...
            do
              if (
                (h.push(t), w.push(y), (y = (y + 1) % 3), !1 === t.C[y].visible)
              ) {
                do
  ...
  var Aa = new (function() {
    ...
    this.cb = function(k, f) {
      for (
        var d = k[0], c = d.x, g = d.y, m = d.x, e = d.y, b = k.length - 1;
        0 < b;
        b--
      )
        (d = k[b]),
  ...
  var Ba = new (function() {
          ...
          if (((q = n[b]), 0 !== q.length)) {
            ...
            if (0 <= w) e(r, f, q, w);
              ...
              var w = [],
                t = [];
              for (h = 0; h < s; h++)
                M.d(q[h][0].ha, q[(h + 1) % s][0].ha) > l &&
                  (w.push(q[h][0].ha), t.push(q[h][2]));
              r.o = w;
              r.C = t;
            }
    ...
    this.zc = function(k, f) {
      ...
      if (g) {
        ...
        for (d = 0; d < c; d++)
          (b = k[d]), e.push({ x: b.x, y: b.y, z: b.x * b.x + b.y * b.y });
        b = za.S(e).Je;
        g = Array(c);
        for (d = 0; d < c; d++) g[d] = {};
        e = b.length;
        ...
        for (c = 0; c < m; c++)
          (d = k[c]),
            (s = Math.min(Math.sqrt(d.f), 0.95 * d.vf)),
            (d.f = s * s);
        this.S(k, f);
        for (c = 0; c < m; c++)
          (d = k[c]),
            d.pe !== d.f &&
              0 < d.uc &&
              ((s = Math.min(d.uc, d.pe - d.f)), (d.f += s), (d.uc -= s));
      }
    };
  })();
  var Ca = new (function() {
    ...
    this.Xb = a(
      function(a, d, c, g, k) {
        function e(a) {
          if (1 < g.length) {
            for (
              var c = g[g.length - 1], e = g[g.length - 2].slice(0), f = 0;
              f < c.length;
              f++
            )
              e.push(c[f]);
  ...
  function La(a) {
    function l(d, c) {
      ...
      Z.F(k, function(a) {
        !0 === a.selected &&
          ((a.selected = !a.selected), (a.I = !a.I), (a.ab = !a.ab));
      });
      var m;
      ...
      c(
        ...
        (function() {
          ...
          return function(c, d) {
            ...
            1 !== e &&
              ((e = Math.pow(e, d.wd)),
              b ? (p.Rg(d, e), a()) : p.Yb(d, e, n.wc, X.pa(n.xc)).N(f));
          };
        })()
      )
    );
  ...
  function Qa(a, l) {
    ...
    this.Nb = function(a) {
      ...
      for (a = 0; a < b.length; a++)
        (f = b[a]),
          (f.qg = f.f),
          (f.rc = (c / Math.PI) * (0 < e ? f.T / e : 1 / b.length));
    };
  }
  function Ra(a, l) {
    function k(a, c) {
    ...
    function f(a) {
      function d(a) {
        ...
        var c = m.cc / (1 + m.cc),
          ...
          g = f.i,
          c = Math.min(
            Math.max(g * c, m.Ce * Math.pow(m.Ra, a.R - 1)),
            g * m.Be
          ),
          h = m.Ic;
        "bottom" == h || (0 <= h && 180 > h)
          ...
          for (g = $.length - 1; 0 <= g; g--)
            if (((h = $[g]), e[h.id]))
              for (var k = h.be, h = 0; h < b.length; h++) {
                var l = b[h];
                !l.parent || (l.parent.Ca && l.parent.M)
                  ? k(l, d)
                  : l.ba.clear();
              }
        }
    ...
    function c() {
      ...
      T.Jc([], function(f) {
        ...
        Z.xd(z, function(a) {
          a.parent &&
            a.parent.Z &&
            (a.ba.clear(), (a.Sa = !0), k || ((a.Fc = !0), a.ac.clear()));
          k && ((a.Fc = !0), a.ac.clear());
        });
    ...
    function g() {
      ...
      "accurate" == u.ef &&
        ...
        !a &&
          ...
          Z.F(z, function(b) {
            if (b.$ && ((b.selected && !b.ab) || (!b.selected && b.ab)))
              return (a = !0), !1;
          }));
      return a;
    }
    ...
    var $ = [
        {
          ...
          be: function(a) {
            if (
              (a.selected || (0 < a.opacity && !1 === a.open) || !a.X) &&
              a.ba.Na()
            ) {
              var b = a.ba;
              b.clear();
                ...
                var d = [
                    ...
                    },
                    {
                      ...
                      hd: function(b, d) {
                        ...
                        e.addColorStop(
                          0,
                          S.Y((f.h + u.qh) % 360, c(f.s + u.sh), c(f.l + u.rh))
                        );
                        e.addColorStop(
                          1,
                          S.Y((f.h + u.uh) % 360, c(f.s + u.wh), c(f.l + u.vh))
                        );
                        b.ba.Ta(d);
                        d.fillStyle = e;
                      }
                    },
                    {
                      ...
                      hd: function(a, b) {
                        ...
                        b.strokeStyle = S.Y(
                          ...
                          c(
                            d.s * a.wa + u.cf + (e ? u.Ue : 0) + (f ? u.$e : 0)
                          ),
                    ...
                    },
                    {
                      ...
                      hd: function(a, b) {
                        var d = a.K.Ob * u.$h,
                          ...
                          h = a.selected,
                          f =
                            (e.h + u.af + (g ? u.Se : 0) + (h ? u.Ye : 0)) %
                            360,
                          k = c(
                            e.s * a.wa + u.cf + (g ? u.Ue : 0) + (h ? u.$e : 0)
                          ),
                          e = c(
                            e.l * a.va + u.bf + (g ? u.Te : 0) + (h ? u.Ze : 0)
                          );
                        d.addColorStop(
                          0,
                          S.Y((f + u.Xh) % 360, c(k + u.Zh), c(e + u.Yh))
                        );
                        d.addColorStop(
                          1,
                          S.Y((f + u.ai) % 360, c(k + u.ci), c(e + u.bi))
                        );
                        b.strokeStyle = d;
                        b.lineWidth = u.nb * Math.pow(u.Ra, a.R - 1);
                      }
            ...
            },
            {
              ...
              wb: function(a, b, c) {
                if (a.Wd && a.selected && !a.ba.Na()) {
                  ...
                  var e = u.Bd;
                  0 < e &&
                    ((b.shadowBlur = e * d * c * b.n), (b.shadowColor = u.We));
                  a.ba.Ta(b);
                  b.closePath();
                  b.stroke();
                }
              ...
              wb: function(a, b, c) {
                ((0 < a.opacity && 0 < a.fa && !a.open) || !a.X) &&
                  ...
                  ((a.Vc =
                    a.ra &&
                    a.ra.la &&
                    u.n * a.ra.fontSize * a.scale * c >= u.Ph),
                  !u.De && a.description
                    ? (a.rb = a.parent.rb)
                    : "auto" === a.Hd
                    ? ((b = a.Qe),
                      ...
                      a.zd !== c &&
                        ((a.rb =
                          S.Cg(b) > (0 > a.ka ? u.di : u.Eh) ? u.Fh : u.Oh),
                        (a.zd = c)))
                    : (a.rb = a.Hd));
              }
            },
            {
              ...
              wb: function(a, b) {
                !((0 < a.opacity && 0 < a.fa && !a.open) || !a.X) ||
                  ...
                  (a.Vc || void 0 === a.ra
                    ? ((b.globalAlpha =
                        a.fa * (a.X ? a.opacity : 1) * (a.empty() ? 1 : u.$f)),
                      (b.fillStyle = a.rb),
                      (b.strokeStyle = a.rb),
                      a.ac.Ta(b))
                    : k(a, b));
  ...
  function Ua(a) {
    ...
    function k(a) {
      ...
      "undefined" !== typeof a.groupLabelVerticalPadding &&
        (d.eb = a.groupLabelVerticalPadding);
      "undefined" !== typeof a.groupLabelMaxTotalHeight &&
        (d.tb = a.groupLabelMaxTotalHeight);
      "undefined" !== typeof a.groupLabelMaxFontSize &&
        (d.sb = a.groupLabelMaxFontSize);
    }
    var f = a.options,
      d = {},
      c = {},
    ...
    this.apply = function() {
      function a(d) {
        if (d.M && d.Ca) {
          ...
          if (d.Z || d.Ma || w) {
            0 === d.R
              ? n(d, (c.Vi * Math.PI) / 180)
              : q(d, (c.Zi * Math.PI) / 180);
    ...
    this.yc = function(a, b) {
      D.defer(function() {
        if (T) u.mi(a), (T = !1);
          ...
          if (b)
            for (var d = x.k(b), e = d.length - 1; 0 <= e; e--) d[e].I = !0;
          else q.I = !0;
          c(a);
        }
      });
        ...
        (function() {
          return {
            ...
            boundingBox: function(a) {
              for (
                var l = a[0].x, k = a[0].y, f = a[0].x, d = a[0].y, c = 1;
                c < a.length;
                c++
              ) {
                var g = a[c];
